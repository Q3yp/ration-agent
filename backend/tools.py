...
def bash_command(command: str, session_id: str) -> str:
...
def create_bash_command_tool(session_id: str):
    ...
    @tool
    def bash_command_for_session(command: str) -> str:
        """Execute a bash command in the session workspace."""
        return bash_command(command, session_id)
...
def get_file_management_tools(session_id: str):
...
def get_tools(session_id: str):
    ...
    file_tools = get_file_management_tools(session_id)
