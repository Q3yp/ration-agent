...
TRANSLATIONS = {
    "zh-CN": {
        ...
        "export.nasem_energy_balance": "能量 vs 目标",
        "export.nasem_me_intake": "ME摄入 (Mcal/d)",
        "export.nasem_me_required": "ME目标 (Mcal/d)",
        "export.nasem_me_balance": "ME vs 目标",
        "export.nasem_me_actual_use": "ME实际消耗 (Mcal/d)",
        "export.nasem_me_actual_balance": "ME实际平衡 (Mcal/d)",
        "export.nasem_body_condition": "体况变化",
        "export.nasem_body_gain": "体重变化预估 (kg/d)",
        "export.nasem_reserve_gain": "脂肪储备变化 (kg/d)",
        "export.nasem_protein_balance": "蛋白质 vs 目标",
        "export.nasem_mp_intake": "MP摄入 (g/d)",
        "export.nasem_mp_required": "MP目标 (g/d)",
        "export.nasem_mp_balance": "MP vs 目标",
        ...
        "export.nasem_aa_balance": "氨基酸平衡",
        "export.nasem_aa_name": "氨基酸",
        "export.nasem_aa_absorbed": "吸收量 (g/d)",
        "export.nasem_aa_target": "目标量 (g/d)",
        "export.nasem_aa_pct_mp": "占MP (%)",
        "export.nasem_aa_target_pct": "目标 (%)",
        "export.nasem_aa_status": "状态",
        "export.nasem_aa_limiting": "限制性氨基酸",
        "export.nasem_aa_adequate": "✓ 充足",
        "export.nasem_aa_deficient": "✗ 不足",
        "export.nasem_aa_none_limiting": "无限制",
        "export.nasem_aa_sheet": "NASEM-氨基酸",
        ...
        "export.milk_price": "奶价 (/kg)",
        "export.cost_per_kg_dm": "成本 (/kg DM)",
        "export.cost_per_cow_day": "每头日成本",
        "export.revenue_per_cow_day": "每头日收入",
        "export.profit_per_cow_day": "每头日利润",
        "export.herd_profit_day": "牛群日利润",
        "export.herd_profit_month": "牛群月利润",
        "export.fc_ratio": "粗精比",
        "export.forage": "粗料",
        "export.concentrate": "精料",
        "export.price_per_kg": "价格 (/kg)",
        "export.cost_per_day": "日成本",
    ...
    "en-US": {
        ...
        "export.nasem_energy_balance": "Energy vs Target",
        "export.nasem_me_intake": "ME Intake (Mcal/d)",
        "export.nasem_me_required": "ME Target (Mcal/d)",
        "export.nasem_me_balance": "ME vs Target",
        "export.nasem_me_actual_use": "ME Actual Use (Mcal/d)",
        "export.nasem_me_actual_balance": "ME Actual Balance (Mcal/d)",
        "export.nasem_body_condition": "Body Condition",
        "export.nasem_body_gain": "Est. BW Change (kg/d)",
        "export.nasem_reserve_gain": "Fat Reserve Change (kg/d)",
        "export.nasem_protein_balance": "Protein vs Target",
        "export.nasem_mp_intake": "MP Intake (g/d)",
        "export.nasem_mp_required": "MP Target (g/d)",
        "export.nasem_mp_balance": "MP vs Target",
        ...
        "export.nasem_aa_balance": "Amino Acid Balance",
        "export.nasem_aa_name": "Amino Acid",
        "export.nasem_aa_absorbed": "Absorbed (g/d)",
        "export.nasem_aa_target": "Target (g/d)",
        "export.nasem_aa_pct_mp": "% of MP",
        "export.nasem_aa_target_pct": "Target (%)",
        "export.nasem_aa_status": "Status",
        "export.nasem_aa_limiting": "Limiting AA",
        "export.nasem_aa_adequate": "✓ Adequate",
        "export.nasem_aa_deficient": "✗ Deficient",
        "export.nasem_aa_none_limiting": "None Limiting",
        "export.nasem_aa_sheet": "NASEM-AA",
